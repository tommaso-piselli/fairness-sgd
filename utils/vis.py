...
def draw_graph(G, pos, ax, xlabel=None, ylabel=None, node_size=0, edge_width=1, node_color = []):
...
def plot(G, pos, lossHistory, i, totalTime, 
    ...
    ax = plt.subplot(121)
    if edge_width > 0:
        draw_graph(G, pos, ax=ax, xlabel=None, ylabel=None, node_size=node_size, edge_width=edge_width, node_color = node_color)
